...
class Ui_PredIt(object):
    def setupUi(self, PredIt):
        ...
        self.resultbutton = QtWidgets.QPushButton(PredIt)
        self.resultbutton.setEnabled(True)
        self.resultbutton.setObjectName("resultbutton")
        self.gridLayout_5.addWidget(self.resultbutton, 8, 0, 1, 1)
    ...
    def retranslateUi(self, PredIt):
        ...
        self.resultbutton.setText(_translate("PredIt", "Compute Result"))
